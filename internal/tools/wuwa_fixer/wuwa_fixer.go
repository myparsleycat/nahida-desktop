...
func (t *Service) WuwaFixerPrepareRun(ctx context.Context, importer *string) (WuwaFixerPrepareResult, error) {
...
func (t *Service) WuwaFixerRun(ctx context.Context, modPath string, options WuwaFixerOptions) error {
	installed, err := t.wuwaGetInstalledBinaryInfo(ctx)
	if err != nil {
		return err
	}
	...
	run, err := t.runner.Begin(ctx)
	if err != nil {
		return err
	}
	defer t.runner.Finish(run)
	t.runner.Log("Running Wuwa Mod Fixer...", false)
	if err := run.Execute(*installed.BinaryPath, db.ScriptTypeExec, modPath, args); err != nil {
		return t.runner.ReportRunError(err)
	}
	t.runner.Log("Completed Wuwa Mod Fixer", false)
	return nil
}

func (t *Service) WuwaFixerScanBackups(ctx context.Context, modPath string) ([]WuwaBackupGroup, error) {
...
func (t *Service) WuwaFixerGetBackupSize(ctx context.Context, modPath string) (WuwaBackupSize, error) {
	if err := t.wuwaRequireModPath(ctx, modPath); err != nil {
...
func (t *Service) WuwaFixerRollbackToGroup(ctx context.Context, modPath, groupKey string) error {
	if err := t.wuwaRequireModPath(ctx, modPath); err != nil {
		return err
	}
...
func (t *Service) WuwaFixerCleanBackups(ctx context.Context, modPath string) error {
	if err := t.wuwaRequireModPath(ctx, modPath); err != nil {
		return err
	}
	paths, err := listWuwaBackupFiles(modPath)
...
//
//wails:ignore
func (t *Service) StartWuwaAutoUpdateCheck() {
	t.wuwaMu.Lock()
...
func (t *Service) stopWuwaAutoUpdateCheck() error {
	t.wuwaMu.Lock()
...
func (t *Service) notifyWuwaAutomaticUpdate(ctx context.Context, oldVersion, newVersion string) {
...
func (t *Service) wuwaRefreshConfigVersion(ctx context.Context) *string {
...
func (t *Service) wuwaLocalConfigVersion() *string {
	configPath, err := t.wuwaConfigPath()
	if err != nil {
		return nil
	}
...
func (t *Service) wuwaConfigPath() (string, error) {
	toolDir, err := t.wuwaToolDir()
	if err != nil {
		return "", err
	}
...
func (t *Service) wuwaGetInstalledBinaryInfo(ctx context.Context) (wuwaInstalledInfo, error) {
...
func (t *Service) wuwaCleanupOldBinaries(current string) error {
...
func (t *Service) wuwaRequireModPath(ctx context.Context, modPath string) error {
...
func (t *Service) wuwaSupportedImporter(importer *string) bool {
	return importer == nil || strings.EqualFold(*importer, "WWMI")
}

func (t *Service) wuwaGetCachedLatestRelease(ctx context.Context) (*wuwaLatestReleaseCache, error) {
...
func (t *Service) reportWuwaRecovery(err error, stage string) {
