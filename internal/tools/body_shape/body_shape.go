...
func (t *Service) BodyShapeLoadMod(ctx context.Context, modPath string) (BodyShapeSessionDescriptor, error) {
...
//wails:ignore
func (t *Service) BodyShapeExport(
	ctx context.Context,
...
func (t *Service) BodyShapeGetMesh(ctx context.Context, input BodyShapeMeshInput) (BodyShapeMeshDescriptor, error) {
	if err := ctx.Err(); err != nil {
...
func (t *Service) BodyShapeBeginExport(
	ctx context.Context,
...
func (t *Service) BodyShapeCommitExport(
	ctx context.Context,
...
func (t *Service) requireBodyShapeSession(id string) (*bodyShapeSession, error) {
	t.bodyShapeMu.Lock()
