...
func (t *Service) FourThousandOneFixerGetState() Fixer4001State {
	t.fixerMu.Lock()
...
func (t *Service) FourThousandOneFixerGetProviderReleases(ctx context.Context, provider string) ([]string, error) {
...
func (t *Service) FourThousandOneFixerGetBuildToolsPath(ctx context.Context) (string, error) {
...
func (t *Service) FourThousandOneFixerSetBuildToolsPath(
	ctx context.Context,
	path string,
...
func (t *Service) FourThousandOneFixerClearBuildToolsPath(ctx context.Context) error {
	return t.deleteAppState(ctx, fixer4001VSDevCmdPathKey)
}

func (t *Service) locate4001VSDevCmd(ctx context.Context) (string, error) {
...
func (t *Service) FourThousandOneFixerGetDiversificationState(input Fixer4001PathInput) (DiversificationState, error) {
...
func (t *Service) FourThousandOneFixerCheckImporterWriteAccess(input Fixer4001PathInput) ImporterWriteAccess {
	path, ok := existingImporterPath(input.ImporterPath)
	if !ok {
...
func (t *Service) FourThousandOneFixerBuildDll(
	ctx context.Context,
...
func (t *Service) FourThousandOneFixerDiversifyDllPadding(
	ctx context.Context,
...
func (t *Service) begin4001Task(task string) bool {
	t.fixerMu.Lock()
	defer t.fixerMu.Unlock()
	if t.fixerTask != nil {
		return false
...
func (t *Service) end4001Task() {
	t.fixerMu.Lock()
	t.fixerTask = nil
	t.fixerMu.Unlock()
}

func (t *Service) update4001Progress(code, errorMessage string) {
	t.fixerMu.Lock()
...
func (t *Service) failed4001(code string, err error) Fixer4001Result {
	message := ""
	if err != nil {
		message = err.Error()
...
func (t *Service) trackD3DBuild(ctx context.Context, id, dir string) error {
...
//
//wails:ignore
func (t *Service) CleanupStaleD3DBuilds(ctx context.Context) error {
	client, err := t.requireClient()
	if err != nil {
		return err
	}
...
func (t *Service) findDiversifierBackup(importerPath string) (*string, error) {
