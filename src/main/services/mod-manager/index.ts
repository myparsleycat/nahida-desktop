...
export class ModManager {
    ...
    public readonly fn: {
        ...
        setNteLauncherPath: ModLibraryService["setNteLauncherPath"];
        startNteLauncher: ModLibraryService["startNteLauncher"];
    ...
    constructor(desktop: NahidaDesktop) {
        ...
        this.fn = {
            ...
            setNteLauncherPath: this.library.setNteLauncherPath.bind(this.library),
            startNteLauncher: this.library.startNteLauncher.bind(this.library),
