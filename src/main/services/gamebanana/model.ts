...
export const ModProfileSchema = z
    .object({
        ...
        _bIsWithheld: z.boolean(),
        _sName: z.string(),
        _sCommentsMode: z.string().optional(),
        _tsDateModified: z.number(),
        _tsDateAdded: z.number(),
        _sProfileUrl: HttpUrlString,
        _aPreviewMedia: PreviewMediaSchema,
        _nUpdatesCount: z.number().optional(),
        _bHasUpdates: z.boolean().optional(),
        _nAllTodosCount: z.number().optional(),
        _bHasTodos: z.boolean().optional(),
        _nPostCount: z.number().optional(),
        _aTags: z.array(z.union([z.string(), z.record(z.string(), z.unknown())])),
        _bCreatedBySubmitter: z.boolean().optional(),
        _bIsPorted: z.boolean().optional(),
        _nThanksCount: z.number().optional(),
        _sInitialVisibility: z.string(),
        _sDownloadUrl: HttpUrlString.optional(),
        _nDownloadCount: z.number().optional(),
        _aFiles: z.array(ModFileSchema).optional(),
        _nSubscriberCount: z.number(),
        _aContributingStudios: z.array(z.unknown()).optional(),
        _sLicense: z.string().optional(),
        _aLicenseChecklist: ModLicenseChecklistSchema.optional(),
        _sDescription: z.string().optional(),
        _bGenerateTableOfContents: z.boolean().optional(),
        _sText: z.string(),
        _bIsObsolete: z.boolean().optional(),
        _nLikeCount: z.number().optional(),
        ...
        _nViewCount: z.number().optional(),
        _sVersion: z.string().optional(),
        _bAcceptsDonations: z.boolean().optional(),
        _bShowRipePromo: z.boolean().optional(),
        _aEmbeddables: z
            .object({
        ...
        _aCredits: z.array(ModCreditsGroupSchema).optional(),
        _idAccessorSubscriptionRow: z.number().nullable().optional(),
        _bAccessorIsSubscribed: z.boolean(),
        _bAccessorHasThanked: z.boolean().optional(),
    })
    .catchall(z.unknown());
