...
function RouteComponent() {
  ...
  const handleMouseEnter = () => {
    window.api.invoke("overlay:setIgnoreMouseEvents", false);
  };

  const handleMouseLeave = () => {
    window.api.invoke("overlay:setIgnoreMouseEvents", true);
  };

  return (
    <>
      <div
        className="flex-1 flex overflow-hidden h-screen bg-background"
