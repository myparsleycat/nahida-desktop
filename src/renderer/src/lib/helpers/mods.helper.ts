...
import type { DirectChildren, Fixx } from '@shared/types/mods.types';
...
class ModsHelperClass {
    ...
    ui = {
        ...
        layout: {
            folder: {
                get: async () => await window.api.mods.ui.layout.folder.get(),
                set: async (layout: 'list' | 'align') => await window.api.mods.ui.layout.folder.set(layout)
            },

            mod: {
                get: async () => await window.api.mods.ui.layout.mod.get(),
                set: async (layout: 'grid' | 'list') => await window.api.mods.ui.layout.mod.set(layout)
            }
        }
    }
