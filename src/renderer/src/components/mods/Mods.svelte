  ...
  <Resizable.PaneGroup direction="horizontal">
    ...
    >
      <div class="h-full w-full flex flex-col">
        ...
        <div class="overflow-y-auto overflow-x-hidden py-2 px-1">
          <div
            class="flex-col justify-center duration-200 space-y-1 select-none h-full overflow-y-auto overflow-x-hidden px-1"
          >
