...
[GitHub Releases](https://github.com/myparsleycat/nahida-desktop/releases/latest) ページで `Nahida-Desktop-Setup-<version>.exe` をクリックすると、最新バージョンのインストーラーをダウンロードできます。
