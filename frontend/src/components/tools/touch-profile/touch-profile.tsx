...
export default function TouchProfileTool({
  ...
  //   setReanalyzing(true);
  //   try {
  //     const next = await unavailableChannel("tools:touchProfileReanalyzeTurn");
  ...
  //   if (!draft) return;
  //   try {
  //     const next = await unavailableChannel("tools:touchProfileSelectTurn");
  //     setDraft(next as unknown as TouchDraft);
  //     setPreviewReloadVersion((v) => v + 1);
  ...
  //   if (loading) return;
  //   try {
  //     await unavailableChannel("tools:touchProfileClearVisionCache");
