...
describe("fuzzy match", () => {
    ...
    it("rejects unrelated single-character substitutions", () => {
        assert.equal(findBestFuzzyMatch(["Lull"], "full", { threshold: 0.85 }), null);
    });

    it("allows single edits after a stable prefix", () => {
        assert.equal(
    ...
    it("returns null when the best score is below threshold", () => {
